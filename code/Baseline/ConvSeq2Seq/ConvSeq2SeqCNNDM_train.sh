export TEXT=../../data/news_corpus/cnndm
export OUTPUT=./output/cnndm_convseq2seq
export OUTPUT_TEXT=cnndm_convseq2seq.out
...
--save-dir $OUTPUT  --keep-best-checkpoints 1 --max-epoch 15 --pretrained False
